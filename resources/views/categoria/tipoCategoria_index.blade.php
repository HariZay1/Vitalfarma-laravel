...
<div class="container mt-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3>LISTA DE<small class="text-muted"> CATEGORIAS</small></h3>
  </div>
        ...
        <div class="card-body">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              @foreach($lis_categoria as $value)
              <tr>
                <td>{{ $con++ }}</td>
                <td>{{ $value->ca_nombre }}</td>
                <td>
                  <?php if($value->ca_estado=='ACTIVO'){ ?>
                ...
                <td><?php echo $value->ca_fecha_reg ?></td>
                <td>
                  <div class="d-flex justify-content-around">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <li><a class="dropdown-item" href="#" onclick="editarCategoria('{{ $value->id }}')">EDITAR</a></li>

                      <li><a class="dropdown-item" href="#" onclick="estadoCategoria('{{ $value->id }}', '{{ $value->ca_estado }}')">CAMBIAR ESTADO</a></li>
                    </ul>
                    <div> <!----Separador----->
                      <div class="vr"></div>
                  </div>
                  ...
                  <div>
                    ...
                    <button title="Eliminar" onclick="eliminarCategoria('<?php echo $value->id; ?>')" class="btn btn-datatable btn-icon btn-transparent-dark">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="nuevoRegistroCategoria" method="post">
          @csrf
          <div class="row g-3">
          
            <div class="col-md-6">
              <label for="ca_nombres" class="form-label">NOMBRE PRESENTACION</label>
              <input type="text" id="ca_nombres" name="ca_nombre" class="form-control" required placeholder="Ingresar...">
...
<script>
$("#nuevoRegistroCategoria").submit(function(event) {
  event.preventDefault();

  document.getElementById('boton').disabled=true;
  
  $.ajax({
    url: '/nuevoRegistroCategoria',
    type: 'POST',
    data: $("form").serialize(),
    success:function(){
      window.location="";
...
function estadoCategoria(id,ca_estado){
  ...
  alertify.confirm("<p>ESTA SEGURO QUE DESEA CAMBIAR EL ESTADO? <br><br><b>ENTER</b> y <b>ESC</b> corresponden a <b>Aceptar</b> o <b>Cancelar</b></p>", function (e) {
        if (e) {
          ...
          $.post('/estadoCategoria', {id,pre_estado}, function() {
            window.location="";
          });
...
function editarCategoria(id,ca_nombres){

$("#myModal").modal('show')
$("#id").val(id)
$("#ca_nombres").val(ca_nombres)
alertify.success("Se ah editado el registro con exito");
}
...
function eliminarCategoria(id) {
  alertify.confirm("¿Está seguro que desea eliminar el registro?", function(e) {
    if (e) {
      alertify.success("Has pulsado  ok");
      $.post('/eliminarCategoria', { id:id, _token: '{{csrf_token()}}' }, function() {
        window.location = "";
      });
    } else { alertify.error("Has pulsado '" + alertify.labels.cancel + "'");
  }
